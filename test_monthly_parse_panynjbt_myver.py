...
# PIP INSTALL CLICK PDFPLUMBER PYARROW
...
@click.command()
@click.option('-d', '--data-dir', default='panynj_crossings', help='Directory containing PDF files')
@click.option('-o', '--output-dir', default='panynj_crossings/database', help='Output directory for parquet files')
...
def main(data_dir: str, output_dir: str, years: str | None):
    ...
    traffic_out = out_path / "traffic.parquet"
    ...
    if all_ezpass:
        ...
        ezpass_out = out_path / "ezpass.parquet"
